...
async function searchMusic(query, page) {
    ...
    const songs = res.result.songs
        ...
        .map(formatMusicItem);
    return {
        isEnd: res.result.songCount <= page * Size,
        data: songs,
    };
}
async function searchAlbum(query, page) {
    ...
    return {
        isEnd: res.result.albumCount <= page * Size,
        data: albums,
    };
}
async function searchArtist(query, page) {
    ...
    return {
        isEnd: res.result.artistCount <= page * Size,
        data: artists,
    };
}
async function searchMusicSheet(query, page) {
    ...
    return {
        isEnd: res.result.playlistCount <= page * Size,
        data: playlists,
    };
}
